...
import DashboardOrders from "@/app/admin/components/DashboardOrders";
import DashboardUsers from "@/app/admin/components/DashboardUsers";
import DashboardProducts from "@/app/admin/components/DashboardProducts";
import DashboardProductsAdd from "@/app/admin/components/DashboardProductsAdd";
    ...
    return (
        <div className={"relative z-10 bg-zinc-50 dark:bg-slate-800 lg:dark:bg-slate-900"}>
            <div className="w-full min-h-[calc(100vh-356px)] lg:min-h-[calc(100vh-324px)] lg:grid lg:grid-cols-[240px_1fr]">
                <div className="border-r h-full flex flex-col justify-between py-3 dark:border-slate-500">
                    {
                        !mounted ? (
                    ...
                    {
                        pathname === ordersLink && (
                            <div className={"hidden px-5 lg:flex lg:flex-col"}>
                                <h3 className={"text-gray-800 font-semibold border-b py-2 dark:border-slate-500 dark:text-gray-300"}>
                                    Order Key
                                </h3>
                                <div
