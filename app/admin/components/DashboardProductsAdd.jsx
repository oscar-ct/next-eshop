...
import DashboardProductsCategorySelect from "@/app/admin/components/DashboardProductsCategorySelect";
                ...
                <div className={"pt-5 h-12 lg:pt-0 flex items-center w-full"}>
                    <div className={"text-2xl font-bold w-4/12 sm:w-28 dark:text-white"}>Step 1.</div>
                    {
                        !productCreated ? (
                            ...
                            <AlertMessage variant={"success"} border={"h-12 w-8/12 sm:w-full"}>
