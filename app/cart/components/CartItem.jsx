...
import ProductQuantitySelect from "@/components/products/ProductQuantitySelect";
        ...
        <>
            <div className={"flex w-full"}>
                ...
                <div className={"w-3/12 sm:w-2/12 flex flex-col items-end justify-between"}>
                    ...
                    <ProductQuantitySelect products={item.countInStock} quantity={item.quantity} item={item}/>
                    <div>
                        <button
