...
const AccountOrdersItem = ({order, index, orderLength}) => {
                            ...
                            return (
                                <div className={"flex flex-col lg:flex-row"} key={product.productId}>
                                    <div className={"w-full lg:w-8/12 flex flex-col"}>
                                        ...
                                        <AccountOrdersItemProduct product={product} index={index} orderSize={order.orderItems.length}/>
                                    </div>
                                        ...
                                        <div className={"w-full flex flex-col md:flex-row lg:flex-col"}>
                                            {
                                                order.trackingNumber && order.isShipped && (
                                                    <div className={"py-2 px-1 w-full"}>
                                                        <div className={`w-full tooltip tooltip-top`} data-tip={copyMessage}>
                                                            <button
