...
class Snake extends React.Component {
    ...
    initGame() {
        ...
        //     (percentageWidth / 100)
        let width =
            document.getElementById('GameBoard').parentElement.offsetWidth > 830 ? 830 : document.getElementById('GameBoard').parentElement.offsetWidth *
            (percentageWidth / 100)
        width -= width % 30
        ...
        let startSnakeSize = this.props.startSnakeSize || 5
        let snake = []
        let Xpos = width / 2
        let Ypos = height / 2
        ...
        return (
            <div
                ...
                style={{
                    ...
                    // borderWidth: 1,
                    // borderColor: this.state.snakeColor
                }}>
