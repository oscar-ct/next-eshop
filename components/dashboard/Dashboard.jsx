                    ...
                    <nav className="flex justify-around lg:flex-col px-4 text-sm font-medium">
                        {LINKS.map(({href, label, icon}) => (
                            <Link
                                ...
                                className=
                                    {
                                    `flex items-center gap-3 rounded-lg px-3 py-2 text-gray-500 transition-all hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50 ${pathname === href && "bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-gray-50"}`
                                    }
                                href={href}
                            >
                                {icon}
